    ...
    E: ParseError<&'a str>,
{
    ...
    let parse_u32 = map(parse_delimited_hex, |hex| {
        u32::from_str_radix(hex, 16).expect("should be valid hex")
    });
...
fn parse_escaped_whitespace<'a, E>(input: &'a str) -> IResult<&'a str, &'a str, E>
where
    E: ParseError<&'a str>,
{
